...
<head>
    ...
    <title>Kebijakan Privasi - Hafizhly</title>
...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-inner">
            ...
            <p class="hero-sub">Bagaimana Hafizhly mengumpulkan, menggunakan, dan menjaga data pribadimu selama menemani ibadah dan hafalanmu sehari-hari.</p>
    ...
    <div class="layout">
        <aside class="toc-wrap">
            ...
            <ul class="toc" id="toc">
                <li><a href="#s1" class="active"><span class="num">01</span> Informasi yang dikumpulkan</a></li>
                <li><a href="#s2"><span class="num">02</span> Penggunaan informasi</a></li>
                <li><a href="#s3"><span class="num">03</span> Keamanan data</a></li>
                <li><a href="#s4"><span class="num">04</span> Pihak ketiga</a></li>
                <li><a href="#s5"><span class="num">05</span> Perubahan kebijakan</a></li>
            </ul>
        </aside>
        ...
        <main>
            <div class="intro-note">
                ...
                <div>Selamat datang di <strong>Hafizhly</strong>. Kami sangat menghargai privasi Anda dan berkomitmen untuk melindungi informasi pribadi Anda. Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi data Anda saat menggunakan layanan kami.</div>
            </div>

            <section class="term" id="s1">
                <div class="term-head">
                    <div class="term-icon"><i class="fas fa-database"></i></div>
                    <div class="term-head-text">
                        <span class="num-label">Bagian 01</span>
                ...
                <ul>
                    ...
                    <li><strong>Data lokasi (GPS):</strong> kami meminta izin akses lokasi hanya untuk menghitung jadwal sholat dan arah kiblat secara akurat (melalui API pihak ketiga). Data lokasi ini diproses secara real-time <span class="not-stored"><i class="fas fa-ban"></i> tidak disimpan</span> di database kami.</li>
                </ul>
            </section>

            <section class="term" id="s2">
                <div class="term-head">
                    <div class="term-icon"><i class="fas fa-sliders"></i></div>
                    <div class="term-head-text">
                        <span class="num-label">Bagian 02</span>
                        <h2>Penggunaan Informasi</h2>
                    </div>
                </div>
                <p>Informasi yang kami kumpulkan digunakan semata-mata untuk:</p>
                <ul>
                    <li>Menyediakan dan memelihara layanan aplikasi Hafizhly.</li>
            ...
            <section class="term" id="s3">
                <div class="term-head">
                    <div class="term-icon"><i class="fas fa-lock"></i></div>
                    <div class="term-head-text">
                        <span class="num-label">Bagian 03</span>
                        <h2>Keamanan Data</h2>
                    </div>
                </div>
            ...
            <section class="term" id="s4">
                <div class="term-head">
                    <div class="term-icon"><i class="fas fa-people-arrows"></i></div>
                    <div class="term-head-text">
                        <span class="num-label">Bagian 04</span>
                        <h2>Pihak Ketiga</h2>
                    </div>
                </div>
                <p>Hafizhly menggunakan API publik (seperti EQuran.id dan Aladhan) untuk menyediakan teks Al-Qur'an, Tafsir, dan Jadwal Sholat. Kami tidak pernah menjual, menyewakan, atau menukar data pribadi Anda kepada pihak ketiga untuk tujuan pemasaran.</p>
            </section>

            <section class="term" id="s5">
                <div class="term-head">
                    <div class="term-icon"><i class="fas fa-arrows-rotate"></i></div>
                    <div class="term-head-text">
                        <span class="num-label">Bagian 05</span>
