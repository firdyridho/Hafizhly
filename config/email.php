...
function kirim_kode_verifikasi($email, $nama, $kode)
{
    ...
    $konten = '
        <tr>
            <td align="center" style="background-color: #10b981; padding: 25px 20px; border-radius: 12px 12px 0 0;">
                <h1 style="color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif; font-size: 26px; margin: 0; font-weight: 800; letter-spacing: 3px; text-transform: uppercase;">HIFZHLY</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 25px 20px 15px; color: #334155; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 1.6;">
                Halo <strong style="color: #0f172a;">' . $nama_aman . '</strong>,
            </td>
        </tr>
        <tr>
            <td style="padding: 0 20px 25px; color: #475569; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 1.6;">
                Selamat datang di <strong>Hifzhly</strong>! Untuk menyelesaikan pendaftaran dan mulai menjelajah, silakan masukkan kode verifikasi berikut:
            </td>
        </tr>
        <tr>
            <td align="center" style="padding: 10px 20px 35px;">
        ...
        <tr>
            <td style="padding: 20px; color: #64748b; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; border-top: 1px solid #e2e8f0;">
                Kode ini hanya berlaku selama <strong style="color: #334155;">15 menit</strong>. Jika kamu tidak merasa mendaftar di Hifzhly, kamu bisa mengabaikan email ini dengan aman.
            </td>
        </tr>';
...
function kirim_kode_reset($email, $nama, $kode)
{
    ...
    $konten = '
        ...
        <tr>
            <td style="padding: 20px; color: #64748b; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; border-top: 1px solid #e2e8f0;">
                Kode ini berlaku selama <strong style="color: #334155;">15 menit</strong>. Jangan berikan kode ini kepada siapa pun. Jika kamu tidak meminta reset password, abaikan email ini dan pastikan akunmu aman.
            </td>
        </tr>';
