                    ...
                    <table role="presentation" width="100%" style="max-width:520px;">
                        ...
                        <tr>
                            <td style="background:#ffffff;border-radius:20px;padding:36px 32px 28px;box-shadow:0 4px 24px rgba(5,150,105,0.08);">
                                <table role="presentation" width="100%">
                                    ...
                                    <tr><td style="height:1px;background:linear-gradient(90deg,#e5e7eb,transparent);margin:16px 0;display:block;"></td></tr>
                                    ' . $konten . '
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center" style="padding:20px 0 0;">
                                <p style="margin:0 0 4px;font-size:0.72rem;color:#94a3b8;">&copy; 2026 Hifzhly &mdash; Pendamping Murojaah Al-Qur\'an Berbasis AI</p>
